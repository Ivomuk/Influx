-- Manual INSERT script for vw6_credit_v1_cap_and_action.
-- Depends on vw3, vw4, and vw5 — run all three first.
...
FROM (
    ...
    vw5_data AS (
        SELECT
            ...
            subscriber_msisdn,
            primary_reason_code
        FROM vw5_credit_v1_reason_codes
    ),
